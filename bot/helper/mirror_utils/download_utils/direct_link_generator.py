...
from bot import LOGGER, UPTOBOX_TOKEN, CRYPT, APPDRIVE_EMAIL, APPDRIVE_PASS, MULTI_TOT
...
def gdtot(url: str) -> str:
    ...
    with rsession() as client:
        MULTI_TOTT = random.choice(MULTI_TOT)
        client.cookies.update({'crypt': MULTI_TOTT})
        client.get(url)
